...
def test_mobile_iOS(mobile_os_name, mobile_os_version, device_name, app_package, app_activity, remote_flag, device_flag, testrail_flag, tesults_flag, test_run_id, app_name, ud_id, org_id, signing_id, no_reset_flag):
    "Run the test."
    try:
