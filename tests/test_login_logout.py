...
Our automated test will do the following:
    #Open the Qxf2 Trainer login page
    #Login
    #Logout
"""
import os,sys,time
...
import conf.login_logout_conf as input_data
...
def test_example_form(base_url,browser,browser_version,os_version,os_name,remote_flag,testrail_flag,tesults_flag,test_run_id,remote_project_name,remote_build_name):
    ...
    try:
        ...
        result_flag = test_obj.login(username=input_data.USERNAME,password=input_data.PASSWORD)
